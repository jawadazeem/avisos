...
class PerformanceHandlerTest {
  ...
  void shouldInvokeNonTimedMethod() throws Throwable {
    Method method = TestNodeService.class.getMethod("normalMethod");
  ...
  void shouldInvokeTimedMethod() throws Throwable {
    Method method = TestNodeService.class.getMethod("timedMethod");
  ...
  void shouldRethrowOriginalException() throws Throwable {
    Method method = TestNodeService.class.getMethod("failingMethod");

    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> handler.invoke(null, method, null));
  ...
  static class TestNodeService implements NodeService {
    ...
    @Override
    public void updateNodeHeartbeat(com.azeem.avisos.controller.model.node.NodeRecord nodeRecord) {}
    ...
    @Override
    public java.util.Optional<com.azeem.avisos.controller.model.node.NodeRecord> getNode(
