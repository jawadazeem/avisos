 ...
 * {@code nodeId:errorCode} pair is logged at ERROR level; subsequent duplicates are suppressed
 * until the 100th occurrence, which is logged at WARN level (and every 100th after that). The dedup
 * cache has no automatic expiry &mdash; call {@code flush()} to clear it.
 */
