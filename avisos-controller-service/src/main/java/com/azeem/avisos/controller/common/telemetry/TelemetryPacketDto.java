 ...
 *
 * <p>This record represents the canonical telemetry format used by the Controller service. It is
 * deserialized from JSON messages received over MQTT and used as the input for downstream
 * processing such as vision analysis, monitoring, and alert generation.
 *
 * <p>The payload field may contain binary data (e.g., images), which is transmitted as
 * Base64-encoded data in JSON and automatically decoded by Jackson during deserialization.
 *
