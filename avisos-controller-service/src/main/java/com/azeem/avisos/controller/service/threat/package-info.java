 ...
 * problematic-labels.yml} at startup. Critical keywords take precedence over warning keywords. If no
 * keyword matches, severity is NONE and no alarm is raised.
 */
