 ...
 * connection to the MQTT broker (auto-reconnect, clean session, configurable timeout) and
 * subscribes to the telemetry topic. Each incoming message is dispatched to the ingress handler on
 * a virtual thread to avoid blocking the Paho callback thread.
 *
