 ...
 *   <li>{@link com.azeem.avisos.controller.instrumentation.Timed} &mdash; marks methods for latency
 *       monitoring with a configurable threshold (default 50 ms). Enforced at runtime by {@code
 *       PerformanceHandler} which logs a warning when execution exceeds the threshold.
 * </ul>
 */
