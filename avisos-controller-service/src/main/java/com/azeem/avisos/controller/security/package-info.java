 ...
 *       authenticated user in an {@code InheritableThreadLocal} so child virtual threads inherit
 *       the caller's identity. Must be cleared after use to prevent memory leaks.
 * </ul>
 *
