...
public class BatteryProvider implements HardwareTelemetryProvider {
  ...
  /**
   * The returned value represents the remaining battery percentage of the primary detected power
   * source.
   *
  ...
  public int getBatteryLevel() {
    ...
    if (powerSources.isEmpty()) {
      log.debug(
          "No battery power source detected; assuming line power at {}%", ASSUMED_LINE_POWER_LEVEL);
