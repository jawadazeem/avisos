...
/**
 * The `SystemHealthService` class provides a stateless com.azeem.avisos.service layer for monitoring
 * the overall health and status of the system. It interacts with the `SecurityHub`
 * to gather data about com.azeem.avisos.devices, alarms, and system modes, and calculates metrics
 * such as fleet health percentage, com.azeem.avisos.alarm density, and system health status.
 *
 * <p>This class is architecturally a singleton and is designed to be lightweight
 * and stateless.</p>
 */
public class SystemHealthService {
    private final SecurityHub hub; // The com.azeem.avisos.core security hub instance for accessing system data
     ...
     * active alarms, com.azeem.avisos.alarm density, system health status, system mode, and the
    ...
    /**
     * Calculates the com.azeem.avisos.alarm density, defined as the ratio of active alarms to a
     * fixed denominator (1000).
     *
     * @return The com.azeem.avisos.alarm density as a double value.
     */
    ...
    /**
     * Calculates the fleet health percentage based on the status of com.azeem.avisos.devices in
