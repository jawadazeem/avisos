...
package com.azeem.avisos.service.hub;
...
public class PerformanceHandler implements InvocationHandler {
    ...
    private final SecurityHubService securityHubServiceImpl;

    public PerformanceHandler(SecurityHubService securityHubServiceImpl) {
